    	...
    	<div id='right'>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editFace');?>" method='post'>
	    			<div class='edit-face'>
                        ...
                        <?php else: ?>
                            /Public/Theme/<?php echo ($style); ?>/Images/noface.gif<?php endif; ?>" width='180' height='180' id='face-img'/>
	    				<p>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editPwd');?>" method='post' name='editPwd'>
    				...
    				<p>
    					<label for="old"><span class='red'>*</span>旧密码：</label>
    					<input type="password" name='old' class='input'/>
    				</p>
    				<p>
    					<label for="new"><span class='red'>*</span>新密码：</label>
    					<input type="password" name='new' class='input' id='new'/>
    				</p>
    				<p>
    					<label for="newed"><span class='red'>*</span>确认密码：</label>
...
<!--[if IE 6]>
    <script type="text/javascript" src="/Public/Theme/<?php echo ($style); ?>/Js/DD_belatedPNG_0.0.8a-min.js"></script>
    <script type="text/javascript">
