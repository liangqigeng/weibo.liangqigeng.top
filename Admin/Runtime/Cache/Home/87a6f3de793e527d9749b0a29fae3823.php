...
<head>
    ...
    <link rel="stylesheet" href="/Admin/Home/View/default/Public/Css/login.css" />
    <link rel="stylesheet" href="/Admin/Home/View/default/Public/Js/JqueryUI/jquery-ui-1.9.2.min.css" />
    <script type="text/javascript" src='/Admin/Home/View/default/Public/Js/jquery-1.8.2.min.js'></script>
    <script type="text/javascript" src='/Admin/Home/View/default/Public/Js/JqueryUI/jquery-ui-1.9.2.min.js'></script>
    <script type="text/javascript" src='/Admin/Home/View/default/Public/Js/login.js'></script>
</head>
<body>
    <div id='top'>
        <a href='http://www.houdunwang.com' target='_blank'>
            <img src='/Admin/Home/View/default/Public/Images/blogo.png' width='270' height='52'/>
        </a>
