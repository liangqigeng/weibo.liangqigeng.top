...
<head>
	...
	<link rel="stylesheet" href="/Admin/Home/View/default/Public/Css/copy.css" />
...
<body>
	<div id='main'>
		...
		<dl>
			...
			<dd>MySQL版本：<span><?php echo mysqli_get_server_info(mysqli_connect("localhost","root",""));?></span></dd>
		</dl>
		<dl>
			<dt>用户信息</dt>
